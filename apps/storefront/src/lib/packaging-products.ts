...
export const PACKAGING_PRODUCTS: CatalogProduct[] = [
   ...
   product({
      ...
      images: [I.rigidBox, I.mailer, I.customBoxMedium],
   ...
   product({
      ...
      images: [I.giftBoxesKraft, I.mailer, I.rigidBox],
   ...
   product({
      ...
      images: [I.bakeryBox, I.rigidBox, I.mailer],
   ...
   product({
      ...
      images: [I.sticker, I.giftBoxesKraft, I.rigidBox],
